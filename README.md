...
3. Enroll page: ![page](/assets/04-3.png)
<br> In order to play the visual novel, the player will have to go through this page. In this page, the user will simulate enrolling as an exchange student in the game's school, where they will input their name and other important information. This information will be used in the game, like when the character calls out the player's name, etc.
